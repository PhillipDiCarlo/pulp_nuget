...
COMPONENT_SOURCE="./pulp_nuget/dist/pulp_nuget-${COMPONENT_VERSION}-py3-none-any.whl"
...
---
scenario: "${TEST}"
plugin_name: "pulp_nuget"
legacy_component_name: "pulp_nuget"
component_name: "nuget"
component_version: "${COMPONENT_VERSION}"
pulp_env: {}
pulp_settings: {"allowed_export_paths": ["/tmp"], "allowed_import_paths": ["/tmp"], "api_root": "/pulp/", "cache_enabled": false}
pulp_scheme: "https"
image:
  name: "pulp"
  tag: "ci_build"
  ...
  webserver_snippet: $(test -f pulp_nuget/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_nuget"
    destination: "pulp_nuget"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
...
azure_test: true
pulp_scenario_settings: {"MEDIA_ROOT": "", "STORAGES": {"default": {"BACKEND": "storages.backends.azure_storage.AzureStorage", "OPTIONS": {"account_key": "REDACTED_TEST_SECRET==", "account_name": "devstoreaccount1", "azure_container": "pulp-test", "connection_string": "DefaultEndpointsProtocol=http;AccountName=devstoreaccount1;AccountKey=REDACTED_TEST_SECRET==;BlobEndpoint=http://ci-azurite:10000/devstoreaccount1;", "expiration_secs": 120, "location": "pulp3", "overwrite_files": true}}, "staticfiles": {"BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage"}}, "domain_enabled": true}
pulp_scenario_env: {}
VARSYAML
fi
