...
./gen-client.sh "../pulp_nuget/nuget-api.json" "nuget" python "pulp_nuget"

pushd pulp_nuget-client
python -m build

twine check "dist/pulp_nuget_client-"*"-py3-none-any.whl"
twine check "dist/pulp_nuget_client-"*".tar.gz"

tar cvf "../../pulp_nuget/nuget-python-client.tar" ./dist
...
# Pack the built site.
tar cvf ../../pulp_nuget/nuget-python-client-docs.tar ./site
popd
popd
